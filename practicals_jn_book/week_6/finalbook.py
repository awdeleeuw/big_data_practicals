...
# 
# One way to find how well our clustering method works is by means of **internal goodness metrics**. These metrics do not require labels (We also have external goodness metrics, but these require lables, and these are often missing in unsupervised learning). 
# 
